...
console.log(chalk.green("[Hyperdactyl] Files loaded..."));

// Load settings  from settings.json.

const settings = require("./settings.json");
console.log(chalk.green("[Hyperdactyl] Settings loaded..."));
...
console.log(chalk.green("[Hyperdactyl] Pages loaded..."));
...
const listener = app.listen(settings.website.port, function() {
  console.log(chalk.green("[Hyperdactyl] Checking for updates..."));
  // no update system yet, soontm
  console.log(chalk.green("[Hyperdactyl] Finishing & deploying Hyperdactyl..."));
  console.log(chalk.green("----------------------------------------------------"));
  console.log(chalk.green("Hyperdactyl: v1"));
  console.log(chalk.green("Release: v1.4.1"));
  console.log(chalk.green("----------------------------------------------------"));
